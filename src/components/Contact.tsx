  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl rounded-2xl shadow-lg px-4 sm:px-8 py-12 flex flex-col items-center bg-gradient-to-br from-purple-700 via-purple-500 to-purple-600 relative">
        <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">Ready to Advance Your Career?</h2>
        <p className="text-lg text-purple-100 text-center mb-8 max-w-2xl mx-auto">
          Join the Korea-ASEAN Digital Academy to gain valuable skills, networking opportunities, and potential job placements. Applications are open until August 31, 2025.
        </p>
        ...
        {/* 안내 띠 */}
        <div className="w-full bg-purple-900 bg-opacity-80 py-3 px-4 text-center rounded-b-2xl absolute left-0 bottom-0">
          <p className="text-purple-100 text-sm">
            For any questions about the application process, please contact the program coordinators at <span className="font-bold">kada@elice.io</span>.
          </p>
        </div>
      </div>
    </motion.section>
