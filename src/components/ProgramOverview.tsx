      ...
      <div className="container-max section-padding">
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Join our comprehensive training program designed to develop digital
            and AI talent
          </motion.p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h4 className="text-xl font-semibold text-purple-800 mb-4">
                BPPTIK Kementerian Komdigi
              </h4>
              <p className="text-gray-600 leading-relaxed">
                Jl. Sekolah Hijau Jalan Jababeka Raya No.2, Simpangan, Kec.
                Cikarang Utara, Kabupaten Bekasi, Jawa Barat 17530, Indonesia
              </p>
            </div>
            <a
